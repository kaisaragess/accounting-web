...
exports.implement_DELETE_admin_product__id = implement_DELETE_admin_product__id;
const verifyToken_1 = require("../../fn/verifyToken");
const Product_1 = require("../model/table/Product");
function implement_DELETE_admin_product__id(engine) {
    engine.implement({
        ...
        fn(param) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const productToDelete = yield Product_1.Product.findOneBy({
                        id: Number(id)
                    });
                    ...
                    yield Product_1.Product.remove(productToDelete);
