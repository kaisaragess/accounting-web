...
const MetodePembayaran_1 = require("../../ts-model/enum/MetodePembayaran");
...
__decorate([
    (0, class_transformer_1.Transform)((param) => ((param === null || param === void 0 ? void 0 : param.value) === null || (param === null || param === void 0 ? void 0 : param.value) === undefined || (param === null || param === void 0 ? void 0 : param.value) === '') ? null : parseInt(param.value)),
    (0, class_validator_1.IsNumber)({}, { message: 'total_amount must be a number (integer)' }),
    __metadata("design:type", Number)
], Transaction.prototype, "total_amount", void 0);
__decorate([
    (0, class_transformer_1.Transform)((param) => ((param === null || param === void 0 ? void 0 : param.value) === null || (param === null || param === void 0 ? void 0 : param.value) === undefined || (param === null || param === void 0 ? void 0 : param.value) === '') ? null : parseInt(param.value)),
    (0, class_validator_1.IsNumber)({}, { message: 'total_product_sold must be a number (integer)' }),
    __metadata("design:type", Number)
], Transaction.prototype, "total_product_sold", void 0);
__decorate([
    (0, class_validator_1.IsEnum)(MetodePembayaran_1.MetodePembayaran, { message: 'methode_payment must be enum MetodePembayaran' }),
...
__decorate([
    ...
    (0, class_validator_1.IsISO8601)({}, { message: 'transaction_date must be an ISO8601 date' }),
